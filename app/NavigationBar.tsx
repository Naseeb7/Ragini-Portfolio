...
const NavigationBar = () => {
  ...
  return (
    <div className='flex border-2 bg-cherry-100 py-3 px-4 justify-between flex-row'>
      ...
      <div className='text-softgold-300 font-bold text-2xl text-plum-700 '>Kranti Ragini Sahu</div>
        </div>
        ...
        <div onMouseEnter={handleEmailEnter} className='hover:cursor-pointer'>
